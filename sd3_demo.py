from ditfastattn_api.api import transform_model_dfa_mmdit, dfa_test_latency
from diffusers import DiTPipeline, AutoPipelineForText2Image, StableDiffusion3Pipeline
import torch
import random

model_id = "/nvme_data/yuanzhihang/docs/OFAFastDiT/tmp/models/stable-diffusion-3-medium-diffusers/"
seed = 3
n_steps = 1
...
dfa_config = transform_model_dfa_mmdit(pipe.transformer, n_steps=n_steps)
